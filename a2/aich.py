...
# Mapper
def get_mapper() -> dict:
    language_set = {'1': {'0':'h', '1':'o', '2':'x', '3':'r', '4':'w', '5':'z', '6':'u', '7':'s', '8':'g', '9':'v', 'a':'i','b':'k','c':'k','d':'l','e':'m','f':'n', '_':'j'},
                '2': {'0':'म', '1':'ण', '2':'य', '3':'क', '4':'न', '5':'ष', '6':'द', '7':'ख', '8':'प', '9':'श', 'a':'ह','b':'ज','c':'ट','d':'त','e':'ए','f':'ग', '_':'फ'}}

    return language_set['2']

# Mapping Key Date Handler
def date_add(ini_date) -> int:
    y = 0
    l = []
    for id in ini_date:
        y = y + int(id)
